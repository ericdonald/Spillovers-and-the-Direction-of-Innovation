...
*Directory
global project "/projectnb/econdept/ericdon/Spillovers and the Direction of Innovation"

*Technology Classes
global class car elec
global type clean dirty
...
*IED Research Classes
global elec_clean_IED_classes RENEWABLE NUCLEAR 34BIOFUE
global elec_dirty_IED_classes 21OILGAS 22COAL
global car_clean_IED_classes 1311VBAT 1312ADVA 1314INFR
global car_dirty_IED_classes 1313ENGI 21OILGAS

*Parameters
**CO2 to Carbon Conversion
global CO2_C = 12/44
**Atmospheric PPM of CO2 to GtC
global PPM_C = 2.13


*Dates
**Year of Industrialization
global ind_year = 1800
